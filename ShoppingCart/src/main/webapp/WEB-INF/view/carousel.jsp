	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="resources/images/img7.jpg" alt="" width="1400
					height="700" class="img-responsive">
			...
			<div class="item">
				<img src="resources/images/img19.jpg" alt="" width="1400"
					height="700" class="img-responsive">
				<div class="carousel-caption">
					<p>
			...
			<div class="item">
				<img src="resources/images/img5.jpg" alt="" width="1400"
					height="700" class="img-responsive">
				<div class="carousel-caption">
